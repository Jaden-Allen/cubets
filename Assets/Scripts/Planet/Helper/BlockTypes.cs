...
public static class BlockTypes {
    ...
    public static BlockTypeEnum Chest => new BlockTypeEnum() { typeId = "chest", registryIndex = 1, type = BlockRegistry.indexToBlock[1] };
    public static BlockTypeEnum Dirt => new BlockTypeEnum() { typeId = "dirt", registryIndex = 2, type = BlockRegistry.indexToBlock[2] };
    public static BlockTypeEnum Glass => new BlockTypeEnum() { typeId = "glass", registryIndex = 3, type = BlockRegistry.indexToBlock[3] };
    public static BlockTypeEnum Grass => new BlockTypeEnum() { typeId = "grass", registryIndex = 4, type = BlockRegistry.indexToBlock[4] };
    public static BlockTypeEnum GrassBlock => new BlockTypeEnum() { typeId = "grass_block", registryIndex = 5, type = BlockRegistry.indexToBlock[5] };
    public static BlockTypeEnum Gravel => new BlockTypeEnum() { typeId = "gravel", registryIndex = 6, type = BlockRegistry.indexToBlock[6] };
    public static BlockTypeEnum OakLeaves => new BlockTypeEnum() { typeId = "oak_leaves", registryIndex = 7, type = BlockRegistry.indexToBlock[7] };
