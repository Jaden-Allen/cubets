...
public class PlayerRigidbodyMovement : EntityComponent
{
    [Header("References")]
    ...
    public override void OnEntityFixedUpdate(bool ignoreLoops) {
        ApplyMovements();
    }
    private void HandleInputs(bool ignoreLoops) {
        ...
        isGrounded = Physics.CheckSphere(groundCheckObject.position, groundDistanceCheck, groundMask);
